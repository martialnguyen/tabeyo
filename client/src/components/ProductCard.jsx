  ...
  return (
    ...
    >
      <div className="relative aspect-square bg-gradient-to-br from-slate-50 to-slate-100">
        ...
        <div className="pointer-events-none absolute inset-x-0 bottom-0 h-16 translate-y-full bg-gradient-to-t from-brand-500/20 to-transparent transition duration-300 group-hover:translate-y-0" />
      </div>
      <div className="space-y-1.5 p-2.5 sm:space-y-2 sm:p-3">
        ...
        <div className="flex items-end justify-between gap-2">
          ...
          <span className="rounded bg-brand-50 px-1.5 py-0.5 text-[11px] font-medium text-brand-700 sm:text-xs">Da ban {product.soldCount || 0}</span>
        </div>
